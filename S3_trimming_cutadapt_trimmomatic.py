...
@transform(trim_adapters_cutadapt,
           regex(r".+/(.+)_trimmed_1\.fq\.gz$"),
           [rf"{data_trimmed_dir}/\1_final_1.fq.gz",
            rf"{data_trimmed_dir}/\1_final_1_unpaired.fq.gz",
            rf"{data_trimmed_dir}/\1_final_2.fq.gz",
            rf"{data_trimmed_dir}/\1_final_2_unpaired.fq.gz"])
